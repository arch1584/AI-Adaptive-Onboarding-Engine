  ...
  return (
    <div className="container">
      <div className="card">
        ...
        {/* About */}
        <div className="about">
          This system analyzes a candidate’s resume against a job description to
          identify skill gaps and generate a structured learning roadmap. It
          enables faster onboarding by aligning candidate capabilities with job
          requirements using automated intelligence.
        </div>
